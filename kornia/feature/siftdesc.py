...
class SIFTDescriptor(nn.Module):
    ...
    def get_pooling_kernel(self) -> torch.Tensor:
        ...
        Returns:
            Copy of the convolution kernel tensor from the pooling layer.
        """
    ...
    def get_weighting_kernel(self) -> torch.Tensor:
        ...
        Returns:
            Copy of the Gaussian kernel tensor.
        """
...
class DenseSIFTDescriptor(nn.Module):
    ...
    def get_pooling_kernel(self) -> torch.Tensor:
        ...
        Returns:
            Copy of the current pooling buffer.
        """
        return self._bin_pooling_kernel_weight.detach().clone()
